...
from app.controllers.duty_staff_controller import duty_staff_controller
...
async def get_duty_staff_api(
    id: int = Query(..., description="勤务人员ID")
):
...
async def delete_duty_staff_api(
    id: int = Query(..., description="勤务人员ID")
):
